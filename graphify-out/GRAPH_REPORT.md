...
## Corpus Check
- 73 files · ~1,244,290 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1053 nodes · 2640 edges · 31 communities detected
- Extraction: 74% EXTRACTED · 26% INFERRED · 0% AMBIGUOUS · INFERRED: 680 edges (avg confidence: 0.77)
...
2. `build_postback_data()` - 46 edges
3. `ParsedPostback` - 42 edges
4. `handle_webhook()` - 40 edges
5. `_as_dict()` - 35 edges
6. `_text_with_actions()` - 33 edges
...
Cohesion: 0.05
Nodes (148): _body_text(), _bool_th(), build_batch_complete_card(), build_confirmation_card(), build_duplicate_warning_card(), build_help_flow_response(), build_help_menu_message(), build_history_batch_list_message() (+140 more)
...
Cohesion: 0.06
Nodes (84): ParsedPostback, _build_settings_input_reply(), _flush_settings_change_to_sheets(), _handle_postback(), Protocol, BatchProgress, clear_collection_meter(), clear_collection_skip_meters() (+76 more)
...
Cohesion: 0.08
Nodes (27): build_progress_message(), _expected_meter_count(), format_progress_message(), generate_batch_id(), get_batch_progress(), get_or_create_batch(), _iso_week(), _now() (+19 more)
