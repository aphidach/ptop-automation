...
Cohesion: 0.07
Nodes (72): ParsedCommand, _after_successful_confirmation(), _build_reply(), _build_settings_edit_prompt(), _build_settings_input_reply(), _build_status_card_message(), _build_status_message(), _build_text_reply() (+64 more)
